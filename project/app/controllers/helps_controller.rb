class HelpsController < ApplicationController
  ...
  def index
    ...
    @link_helps=[
      ...
      "Vaya al menu, Registro Varios, luego click en Destinatarios, aqui podras crear, editar  y borrar posibles destinatarios de paquetes, ademas de poder asignar varias dirección a un mismo destinatario",
      ...
      "Vaya al menu, Notas, Guia de Transporte, luego click Buscar Guia, debes cargar algun campo de la pagina o combinación de varios para obtener la/s guia/s que estas buscando",
